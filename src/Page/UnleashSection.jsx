      ...
      <div className="container mx-auto max-w-full w-full lg:max-w-[1140px]  px-[20px] ">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 items-center">
          <div>
            <h4 className="woodmart-title-container  text-[36px] text-[#242424] poppins font-semibold">
              Unleash the Power of Dolphin Meme Tokens at the exclusive Kahoo Store
            </h4>
          </div>
          <div className="elementor-widget-container">
            <span style={{ color: '#2596be' }} className="text-[19px] poppins font-normal">
              Why just hold your tokens when you can shop with them? Dive into the future of e-commerce with Dolphin
              tokens (DOL) at the Kahoo Store, the premier online marketplace for sports apparel and equipment.
            </span>
          </div>
        </div>
        <div className="grid grid-cols-1 py-10 gap-10 md:grid-cols-2 items-start ">
          ...
          >
            ...
            <div>
              <h4 className="text-white sue text-[35px] leading-1 font-semibold" data-elementor-setting-key="title">
                Seamless Shopping with Dolphin <br /> Tokens
              </h4>
              <div className="elementor-widget-container roboto">
                <strong>
                  <span className="text-white">
                    At the Kahoo Store, we’re revolutionizing online shopping by integrating Dolphin tokens as the
                    exclusive preferred payment method.
                  </span>
                </strong>
              </div>
              <div className="mt-3">
          ...
          >
            <div className="flex-shrink-0 w-[70px] h-[56px]">
              <img src="/assets/IMG_7929-removebg-preview.webp" className="w-full h-full object-contain" alt="" />
            </div>
            <div>
              <h4 className="text-white sue text-[35px] leading-1 font-semibold" data-elementor-setting-key="title">
